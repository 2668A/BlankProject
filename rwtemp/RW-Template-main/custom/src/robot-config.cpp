...
motor left_chassis1 = motor(PORT2, ratio6_1, true);
motor left_chassis2 = motor(PORT3, ratio6_1, true);
motor left_chassis3 = motor(PORT4, ratio6_1, false);
...
motor right_chassis2 = motor(PORT6, ratio6_1, false);
motor right_chassis3 = motor(PORT7, ratio6_1, true);
...
motor lever = motor(PORT17, ratio36_1, false);
