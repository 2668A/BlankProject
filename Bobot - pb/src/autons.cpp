...
void default_constants() {
  // P, I, D, and Start I
  chassis.pid_heading_constants_set(2, 0, 20);
  chassis.pid_drive_constants_set(20, 0, 140);
  chassis.pid_turn_constants_set(2, 0, 20, 15);
  chassis.pid_swing_constants_forward_set(5, 0, 20);
  chassis.pid_swing_constants_backward_set(4,0,20);
  chassis.pid_odom_angular_constants_set(2, 0.0, 15);    // Angular control for odom motions
