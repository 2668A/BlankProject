...
ez::tracking_wheel horiz_tracker(-14, 2, 2.25);  // This tracking wheel is perpendicular to the drive wheels
ez::tracking_wheel vert_tracker(20, 2, 1.75);   // This tracking wheel is parallel to the drive wheels
